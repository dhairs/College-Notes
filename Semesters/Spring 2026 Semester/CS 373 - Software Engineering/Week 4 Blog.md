...
That finally clicked in class, though, when we learned about how the different data structures work in Python. I had always wondered why it was possible to use tuples as a key for dictionairies
